    ...
    <footer className="bg-slate-800 text-white py-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">متجر الأناقة</h3>
            <p className="text-slate-400 text-sm">تسوق بذوق - تشكيلة مميزة من أفضل المنتجات بأفضل الأسعار</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="#" className="bg-slate-700 p-2 rounded-lg hover:bg-emerald-600 transition-colors">
